...
class Platform:
    ...
    def __init__(self,
                 idea_id: int = 0,
                 model_configuration: str = '/home/shuaichen/code/virtual_scientists/sci_platform/configs/model_configs.json',
                 ...
                 log_dir: str = '/home/shuaichen/code/virtual_scientists/sci_platform/logs',
                 info_dir: str = '/home/shuaichen/code/virtual_scientists/sci_platform/info',
...
def run_platform(args):
        ...
        platform = Platform(idea_id=idea_id, paper_idx=paper_idx)
        platform.running()
...
if __name__ == "__main__":
    ...
    for paper_idx in args.paper_idxs:
        ...
        with mp.Pool(processes=min(args.num_processes, len(args.idea_ids))) as pool:
            pool.map(run_platform, params)
            
        print(f"Finished processing all ideas for paper_idx {paper_idx}")
    
    # example 
    # python sci_platform.py --idea_ids 0 1 --paper_idx 127
